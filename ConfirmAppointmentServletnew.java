...
public class ConfirmAppointmentServletnew extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String updateSql = "UPDATE appointmentsnew SET status = 'CONFIRMED' WHERE appointment_id = ?";
            ...
            if (row > 0) {
                response.sendRedirect("doctor-dashboard.jsp?success=Appointment confirmed successfully!");
            } else {
                response.sendRedirect("doctor-dashboard.jsp?error=Failed to confirm appointment");
            }
